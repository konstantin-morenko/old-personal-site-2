...
[читателями]({% link howto-write-book/idea-to-toc.md %}#readers).  Может
...
howto-write-book/book-site.md %}#description).  Одним словом,
...
howto-write-book/publication.md %}#prepub)) ссылки целесообразно делать в виде
