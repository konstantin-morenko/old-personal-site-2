---
title: Электронные средства контроля версий файлов (Как написать книгу)
keywords: howto, write, book
permalink: /htwb_versions.html
...
## Индивидуальная система именований файлов

{% include note.html content="Раздел находится в процессе написания." %}

- [Далее: Дневник](/htwb_diary.html)
- [Назад: Программа для работы с изображениями](/htwb_image_processor.html)
