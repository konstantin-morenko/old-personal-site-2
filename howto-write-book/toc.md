...
* [Режим работы над книгой]({% link howto-write-book/routine.md %})
  ...
  * [Сеанс писательской работы]({% link howto-write-book/writing-session.md %})
    ...
    * [Работа с текстом]({% link howto-write-book/text-work.md %})
      ...
      * [Редактирование]({% link howto-write-book/editing.md %})
        ...
        * [Проверка ссылок]({% link howto-write-book/links.md %})
	    * [Исправление текста]({% link howto-write-book/fixing-typos.md %})
    ...
    * [Работа с командой обеспечения]({% link howto-write-book/group-session.md %})
      * [Динамическая команда]({% link howto-write-book/dynamic-group.md %})
    ...
    * [Публикация]({% link howto-write-book/publication.md %})
      * [Предварительная публикация]({% link howto-write-book/prepub.md %})
        * [Трансформация статей в Интернете в книгу]({% link howto-write-book/articles-transform.md %})
      * [Сайт книги]({% link howto-write-book/book-site.md %})
	    * [Страница текста]({% link howto-write-book/book-html.md %})
        * [Оценка посещаемости]({% link howto-write-book/metrics.md %})
        * [Собственное доменное имя]({% link howto-write-book/domain.md %})
		* [Социальные сети]({% link howto-write-book/social-nets.md %})
  ...
  * [Изменяющиеся условия среды]({% link howto-write-book/changing-environment.md %})
    * [Планирование времени и обстоятельств]({% link howto-write-book/environment.md %})
    * [Окружающая обстановка]({% link howto-write-book/env-place.md %})
      * [Фоновая музыка]({% link howto-write-book/env-music.md %})
    * [Режим дня]({% link howto-write-book/day-schedule.md %})
	  * [Настрой вне работы]({% link howto-write-book/affirm.md %})
