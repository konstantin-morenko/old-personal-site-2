...
зрения [принципов качества](quality-management.md) это хорошо, потому
что означает, что текст лучше подготовлен изначально.

По ходу своих занятий я рекомендую записывать затраты времени в
[дневник](diary.md), это пригодится для нескольких целей.
...
работы](writing-session.md)) и сравнивайте результаты с предыдущими.
